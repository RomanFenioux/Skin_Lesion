...
%TODO importance of skin lesion analysis : helps the diagnosis of melanoma, melanoma is very bad, high cost for dermatologist because lot of images to see, automated and semi automated procedure could speed up the process and make it easier + reduce inter- and intra-expert variability because more reproductible (discuss influence of initialisation), it provides quantitative information. And segmentation specifically : first step for classif, allows shape analysis and localised feature extraction

\end{abstract}
\section*{Introduction}
%TODO explain ISIC challenge data, what is ISIC, etc...
